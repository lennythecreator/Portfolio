  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-12 py-20 sm:py-24 md:py-32">
        ...
        >
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4 glow-text">
        ...
        >
          <Card className="border-primary/20">
            ...
            <CardContent className="space-y-3 md:space-y-4 p-4 sm:p-5 md:p-6">
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">{backGround}</p>
        ...
        >
          ...
          <motion.div
            className="relative border-l-2 border-primary/30 pl-4 sm:pl-6 md:pl-8 space-y-6 md:space-y-8"
          ...
          >
            {EXPERIENCE.map((exp, index) => (
              <motion.div key={index} variants={itemVariants} className="relative">
                <div className="absolute -left-[25px] sm:-left-[33px] md:-left-[41px] top-0 w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 rounded-full bg-primary border-2 sm:border-3 md:border-4 border-background shadow-glow-blue" />

                <Card className="hover:border-primary/50 transition-all duration-300 hover:shadow-glow">
                  <CardHeader className="p-4 sm:p-5 md:p-6">
                    <div className="flex flex-col gap-1.5 md:gap-2 mb-2">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-2">
                        ...
                        <span className="text-xs sm:text-sm text-muted-foreground">{exp.date}</span>
                      </div>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 text-primary font-medium text-sm md:text-base">
