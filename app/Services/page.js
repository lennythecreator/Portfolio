  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="px-4 sm:px-6 md:px-12 lg:px-20 py-20 sm:py-24 md:py-32">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold py-2 glow-text mb-4">
            ...
            return (
              <motion.div key={index} variants={cardVariants}>
                <Card className="h-full group hover:border-primary/50 relative overflow-hidden flex flex-col">
                  ...
                  <CardHeader className="relative p-5 md:p-7">
                    <div className="flex items-start gap-4 mb-4">
                      <div className="p-3 md:p-3.5 rounded-lg bg-primary/10 group-hover:bg-primary/20 transition-colors duration-300 flex-shrink-0">
                        <IconComponent className="w-6 h-6 md:w-7 md:h-7 text-primary" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <CardTitle className="text-xl sm:text-2xl font-bold group-hover:text-primary transition-colors duration-300 mb-2">
                          {service.title}
                        </CardTitle>
                  ...
                  <CardContent className="relative p-5 md:p-7 pt-0 md:pt-0 flex-grow">
                  ...
                  <CardFooter className="relative p-5 md:p-7 pt-4 md:pt-4 mt-auto border-t border-border/30">
        ...
        >
          <div className="bg-card border border-border rounded-2xl p-6 md:p-8 mb-8">
            <h3 className="text-xl md:text-2xl font-bold mb-3">Ready to Get Started?</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <MagneticElement strength={0.2}>
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-300 hover:shadow-glow-blue hover:scale-105 text-sm md:text-base"
                >
              ...
              <MagneticElement strength={0.2}>
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-secondary text-secondary-foreground hover:bg-secondary/80 transition-all duration-300 hover:shadow-glow hover:scale-105 text-sm md:text-base"
                >
